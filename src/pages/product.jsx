...
export default function Product() {
  return (
    <section className={styles.container}>
        ...
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ea quaerat ratione cupiditate corporis aliquam! Consectetur veritatis quod recusandae. Rerum, fuga officiis consequuntur voluptatem adipisci et necessitatibus iusto quaerat consectetur deleniti.</p>
